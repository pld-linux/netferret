...
Net Ferret to narzędzie pomagające otrzymać szybciej rezultaty przy
przeszukiwaniu Internetu. Działa jako aplet toolbaru GNOME. Szukanie
jest wystarczająco bolesne nawet bez tych wszystkich stron
początkowych wyszukiwarek z tysiącami reklam...
